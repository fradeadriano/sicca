<?
if(!stristr($_SERVER['SCRIPT_NAME'],"devolucion.php")){
			...
			if($search->total_registros != 0)
			{
				...
				$bus->sql = "SELECT crp_recepcion_correspondencia.n_correlativo, DATE_FORMAT(crp_recepcion_correspondencia.fecha_documento,'%d/%m/%Y') AS fdocumento, DATE_FORMAT(crp_recepcion_correspondencia.fecha_registro,'%d/%m/%Y %r') AS registro, crp_recepcion_correspondencia.n_documento,
							  ...
							  crp_recepcion_correspondencia.gaceta_tipo, crp_recepcion_correspondencia.observacion, crp_recepcion_correspondencia.anexo,
							   ...
							   crp_asignacion_correspondencia.copia_unidades, crp_asignacion_correspondencia.unidades_apoyo, crp_asignacion_correspondencia.id_asignacion_correspondencia, crp_asignacion_correspondencia.observacion AS obser_asig
							FROM
				...
				if($bus->total_registros != 0)
				{
					...
					$obser_asig = $bus->fila["obser_asig"];											
				}
			}
	}
}
	...
	<tr>
		<td align="center">
			<table width="99%" align="center" cellpadding="2" cellspacing="0">
				<tr>
					<td width="30px"><img src="images/devolucion.png"/></td>
					<td class="titulomenu" valign="middle">Devoluci&oacute;n Correspondencia</td>
				</tr>
				<tr>
...
<?
								...
								<td>
									...
									<table cellspacing="3" cellpadding="2" border="0" width="100%">
										...
										<tr>
											...
											<td>
												<textarea name="motivo" id="motivo" style="width:450px; height:75px" onkeyup="return maximaLongitud(this.id,300);"></textarea>&nbsp;<span class="mensaje">*</span>
												<br /><span style="font-size:9px">M&aacute;ximo 300 Caracteres</span>
											</td>
										</tr>
										<tr height="25" valign="bottom"><td align="right" class="mensaje" colspan="2">* Campos Obligatorios&nbsp;&nbsp;</td></tr>																																									
									</table>
									</fieldset>									
								</td>
							</tr>
							<tr>
								<td align="left" class="mensaje">
									<u>Nota:</u><br />
									<p align="justify">
										Desde este formulario usted registrar&aacute;, de ser necesario, la devoluci&oacute;n a la correspondencia seleccionada.
									</p><br /><br />
								</td>
							</tr>							
							<tr>
								<td align="center">
									...
									<input type="button" name="btnRegistrar" id="btnRegistrar" value="Registrar Devoluci&oacute;n" title="Registrar Devoluci&oacute;n" onclick="devolucion();" />
									&nbsp;&nbsp;
