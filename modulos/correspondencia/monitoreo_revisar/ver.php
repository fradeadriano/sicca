							...
							<tr>
								<td>
									...
									<table cellspacing="3" cellpadding="2" border="0" width="100%">
										<tr>
											<td align="right" width="150">
												<b>Fecha Asignaci&oacute;n:</b>&nbsp;											</td>
											<td>
												<? 
													echo $f_asignacion;
												?>											</td>											
										...
										<tr>
											<td align="right" width="190">
												<b>Acci&oacute;n:</b>											</td>
											<td>
												Correspondencia para <? echo "<u>".$accion."</u> y ".$externo;?> </td>
										</tr>
										<?
										...
										<tr>
											<td align="right" width="190">
												<b>Prioridad:</b>											</td>
											<td>
												<? echo "<b><u>".$prioridad."</u></b>"; if ($plazo!="") {echo " Con un Plazo de ".$plazo." d&iacute;as."; }?>											</td>
										</tr>
										<tr>
											<td align="right" width="190">
												<b>Estatus:</b>											</td>
											<td>
												<? echo "<b><u>".$estatus."</u></b>"; ?>											</td>
										</tr>																																								
										<?
										}
