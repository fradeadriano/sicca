		...
		<td>
			<table width="99%" align="center" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td class="titulomenu" valign="middle">Correspondencias Internas Enviadas</td>
				</tr>
				<tr>
...
<!--								<td align="right">Mensajero:&nbsp;</td>
							...
							<tr>
								...
								<td>
									...
									$rsun->llenarcombo($opciones = "\"tipOficio\"", $checked = "", $fukcion = "" , $diam = "style=\"width:150px; Height:20px;\""); 
									$rsun->cerrar(); 
									unset($rsun);																						
									?>								
								</td>																															
							...
							<tr class="trcabecera_list_ordenar">
								<td height="33">
									&nbsp;&nbsp;Ordenado por:&nbsp;&nbsp;<select name="por_ordenar" id="por_ordenar" onchange="filtrar(this.value);">
										...
										<option value="columna3">Organ&iacute;smo</option>							
								...
								<td align="right" valign="middle">
									<img src="images/actualizar.png" style="cursor:pointer" title="Actualizar P&aacute;gina" onclick="cargar_lista_corres('modulos/correspondencia/monitoreo_externo/monitoreo_list.php?pagina=1&met=DESC');" />&nbsp;&nbsp;Actualizar&nbsp;&nbsp;&nbsp;
								</td>
							</tr>				
							<tr>
...
<?
echo '<script language="javascript" type="text/javascript">cargar_lista_corres("'.'modulos/correspondencia/monitoreo_externo/monitoreo_list.php?pagina=1&met=DESC");</script>'; 
?>
<script language="javascript" type="text/javascript">
	$("#organismo").autocomplete("modulos/correspondencia/monitoreo_externo/lista.php", { 
		width: 400,
		matchContains: true,
		mustMatch: false,
		//minChars: 0,
...
setInterval('cargar_lista_corres("modulos/correspondencia/monitoreo_externo/monitoreo_list.php?pagina=1&met=DESC")',1800000);		
</script>