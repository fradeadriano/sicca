...
function filtrar(co){
	...
	if(res==""){
		rt = "modulos/correspondencia/monitoreo_interno/monitoreo_list.php?pagina=1&p_orden="+co+"&met="+metod; 
	} else {
		rt = "modulos/correspondencia/monitoreo_interno/monitoreo_list.php?pagina=1&p_orden="+co+"&met="+metod+"&condiciones="+res; 	
	}	
	llamarlistado(rt,spasc);
}
//7
...
function doit(){
	...
	var ruta = "modulos/correspondencia/monitoreo_interno/monitoreo_list.php?pagina=1&condiciones="+param+"&met=DESC";
//	alert(ruta);	
...
var f2 = "";
	...
	if (document.getElementById("tipOficio").value == null || document.getElementById("tipOficio").value.length == 0 || /^\s+$/.test(document.getElementById("tipOficio").value)){		
			...
			// campo2 = noficio
			if (param==""){
				param = "campo5:"+document.getElementById("tipOficio").value;				
			} else {
				param = param+"!campo5:"+document.getElementById("tipOficio").value;							
			}		
		}
...
/*	if (document.getElementById("unidad").value != "" || document.getElementById("unidad").value.length != 0)
	...
	if (document.getElementById("tipOficio").value != "" || document.getElementById("tipOficio").value.length != 0)
	{
		// campo2 = documento
		if (param==""){
			param = "campo5:"+document.getElementById("tipOficio").value;				
...
//	inff = "&fecha="+document.getElementById("fentrega").value+"&hora="+document.getElementById("hentrega").value+"&minuto="+document.getElementById("mentrega").value;
	...
	if(window.confirm(acentos('Desea registrar la entrega de la correspondencia?'))) 
		{	
			rt = "modulos/correspondencia/monitoreo_interno/reg_asignacion.php?recep="+document.getElementById("id_corre_ex").value+"&modo=recibir"+inff; 	
			llamarlistado(rt,spasc);
			alert(acentos("Ha finalizado satisfactoriamente el registro de la entrega!"));
			cargar_lista_corres('modulos/correspondencia/monitoreo_interno/monitoreo_list.php?pagina=1&met=DESC');
			closeMessage();		
		}
}
...
function anular(){
	...
	if(window.confirm(acentos('Desea Anular el Oficio?'))) 
		{	
			rt = "modulos/correspondencia/monitoreo_interno/reg_asignacion.php?recep="+document.getElementById("id_corre_ex").value+"&modo=anular"; 	
			llamarlistado(rt,spasc);
