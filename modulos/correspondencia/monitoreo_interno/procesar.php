	...
	<tr>
		<td align="center">
			<table width="99%" align="center" cellpadding="2" cellspacing="0">
				<tr>
					<td width="30px"><img src="images/enviar.png"/></td>
...
<?
							...
							<tr>
								<td align="center" colspan="4">					
									<table cellpadding="2" ccellspacing="0" border="0" width="99%">
										<tr>
											<td align="right">
							...
							<tr>
								<td colspan="4">
									...
									<table border="1" cellpadding="2" ccellspacing="0" width="99%">
										<tr>
											<td width="150" align="right">
												<b>N&deg; Oficio:</b>
											</td>
											<td width="200">
												<input type="text" name="n_oficio_ext" id="n_oficio_ext" style="width:115px" maxlength="6" onkeypress="return validar(event,numeros)"/>
											</td>
											<td width="120" align="right">
												<b>Plazo:</b>
											</td>
											<td>
												&nbsp;<input type="text" name="plazo" id="plazo" style="width:20px" maxlength="2"/>&nbsp;d&iacute;as
											</td>
										</tr>
										...
										<tr>
											...
											<td><? 
												...
												$rsmen->llenarcombo($opciones = "\"tipo_documento\"", $checked = "", $fukcion = "" , $diam = "style=\"width:120px; Height:20px;\""); 
												$rsmen->cerrar(); 
												unset($rsmen);																						
												?>
											</td>
										...
										<tr>
											...
											<td><div style="z-index:1">
												<textarea name="organismo_reci" id="organismo_reci" style="width:300px; height:55px;" ></textarea>
												<input type="hidden" name="id_organismo_reci" id="id_organismo_reci"  /></div>
											</td>
										</tr>										
										<tr height="25" valign="bottom"><td align="right" class="mensaje" colspan="5">Todos los Campos Obligatorios&nbsp;&nbsp;</td></tr>																														
									</table>
									</fieldset>									
								</td>
							</tr>							
							<tr>
								<td align="center" colspan="4">
									...
									<input type="button" name="btnRegistrar" id="btnRegistrar" value="Registrar Envio" title="Registrar Envio" onclick="" />
									&nbsp;&nbsp;
...
<script language="javascript" type="text/javascript">
	$("#organismo_reci").autocomplete("modulos/correspondencia/monitoreo_externo/lista.php", { 
		width: 300,
		matchContains: true,
		mustMatch: false,
		//minChars: 0,
