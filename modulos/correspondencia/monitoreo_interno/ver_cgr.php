<?
if(!stristr($_SERVER['SCRIPT_NAME'],"ver_cgr.php")){
...
//					$ = $bus->fila[""];											
				...
				$bus->sql = "SELECT 
									  ...
									  crp_recepcion_correspondencia_cgr.plazo,estatus.estatus, estatus.id_estatus
				...
				if($bus->total_registros != 0)
				{
					...
					$estatus_n = $bus->fila["estatus"];						
					$idestatus_n = $bus->fila["id_estatus"];											
					...
					<td align="center">
						...
						<table border="0" cellpadding="3" ccellspacing="2" width="99%">						
							...
							<tr>
								...
								<td>
									<? 
										echo "<span class='mensaje'>".$estatus_n."</span>";
									?>																								
								</td>	
							</tr>							
<!--							<tr>
