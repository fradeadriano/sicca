						...
						<table border="0" width="100%" class="b_table_b" bgcolor="#F8F8F8"  cellpadding="2" cellspacing="0">
							<tr>
								...
								<td valign="bottom">
									<? 
									$rses = new Recordset();
									$rses->sql = "SELECT id_estatus, estatus FROM estatus order by orden"; 
							...
							<tr>
								<td valign="bottom" align="left"  colspan="4">
									Unidad Administrativa:&nbsp;<? $rsun = new Recordset();	$rsun->sql = "SELECT id_unidad, unidad FROM unidad  order by unidad"; 
						...
						<table border="0" class="b_table" width="980" cellpadding="0" cellspacing="0">
							<tr class="trcabecera_list_ordenar">
								...
								<td align="right" valign="middle">
									<img src="images/actualizar.png" style="cursor:pointer" title="Actualizar P&aacute;gina" onclick="cargar_lista_corres('modulos/correspondencia/monitoreo/monitoreo_list.php?pagina=1&met=DESC');" />&nbsp;&nbsp;Actualizar&nbsp;&nbsp;&nbsp;
								</td>
							</tr>	
										
							<tr>
								<td id="zone" colspan="2">&nbsp;
<!--									<table border="0" class="b_table1" align="center" width="100%">
										...
										<tr class="trresaltado">
											...
											<td>
												<a style="cursor:pointer"><? //echo ucwords(mb_strtolower("SECRETAR&Iacute;A SECTORIAL DEL PODER POPULAR PARA LA CULTURA")); ?><span class="tooltip"><center>Clic para ver ruta del documento</center></span></a>
											</td>
											<td>
												Pedro Perez
											</td>
											...
											<td>
												<a style="cursor:pointer">Por Asignar<span class="tooltip"><center>Clic para ver ruta del documento</center></span></a>
											</td>
											<td>
												<a style="cursor:help">
													<img src="images/editar.png" style="cursor:pointer" /><span class="tooltip"><center>Clic para asignar la unidad</center></span>
												</a>	
											</td>																						
										</tr>
									</table>		
...
<!--										<tr><td height="5"></td></tr>								
										<tr bgcolor="#f6f5ee" height="30">
											<td align="right">Ver Asignaci&oacute;n:&nbsp;&nbsp;</td>
											<td>
								...
								<td valign="top" align="center">
									<table width="720" border="0" cellpadding="0" cellspacing="0" align="center" class="b_table">
										...
										<tr>
											<td>
												<iframe height="200" name="iesta" id="iesta" frameborder="0" src="modulos/correspondencia/monitoreo/estatus.php"></iframe>
											</td>
										</tr>
									</table>
								</td>
...
echo '<script language="javascript" type="text/javascript">cargar_lista_corres("modulos/correspondencia/monitoreo/monitoreo_list.php?pagina=1&met=DESC");</script>'; 
?>
...
<script language="javascript" type="text/javascript">
	$("#organismo").autocomplete("modulos/correspondencia/monitoreo/lista.php", { 
		width: 400,
		matchContains: true,
		mustMatch: false,
		//minChars: 0,
...
setInterval('cargar_lista_corres("modulos/correspondencia/monitoreo/monitoreo_list.php?pagina=1&met=DESC")',1800000);	
