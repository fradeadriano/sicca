<?
if(!stristr($_SERVER['SCRIPT_NAME'],"entregado_copia.php")){
		...
		<td align="center">
			<table width="100%" align="center" cellpadding="2" cellspacing="0">
				<tr>
					...
					<td class="titulomenu" valign="middle">Visualizar Correspondencia Entregada</td>
				</tr>
				<tr>
									...
									<?
										...
										{													
											for($i=0;$i<$rsdocu->total_registros;$i++){
												$rsdocu->siguiente();
												echo "<span class='mensaje'>- ".$rsdocu->fila["unidad"].".</span><br>";
												
											}												
										} else {
											$rsdocu->siguiente();
											echo "<span class='mensaje'>".$rsdocu->fila["unidad"].".</span>";													
										}
									?>
								</td>
							</tr>
