...
function filtrar(co){
	...
	if(res==""){
		rt = "modulos/correspondencia/monitoreo/monitoreo_list.php?pagina=1&p_orden="+co+"&met="+metod; 
	} else {
		rt = "modulos/correspondencia/monitoreo/monitoreo_list.php?pagina=1&p_orden="+co+"&met="+metod+"&condiciones="+res; 	
	}	
	llamarlistado(rt,spasc);
}
//7
...
function doit(){
	...
	var ruta = "modulos/correspondencia/monitoreo/monitoreo_list.php?pagina=1&condiciones="+param+"&met=DESC";
	//alert(ruta);	
