<?
if(!stristr($_SERVER['SCRIPT_NAME'],"aprobar.php")){
			...
			if($search->total_registros != 0)
			{
				...
				$bus->sql = "SELECT crp_recepcion_correspondencia.n_correlativo, DATE_FORMAT(crp_recepcion_correspondencia.fecha_documento,'%d/%m/%Y') AS fdocumento, DATE_FORMAT(crp_recepcion_correspondencia.fecha_registro,'%d/%m/%Y %r') AS registro, crp_recepcion_correspondencia.n_documento,
							  ...
							  crp_recepcion_correspondencia.gaceta_tipo, crp_recepcion_correspondencia.observacion, crp_recepcion_correspondencia.anexo,
							   ...
							   estatus.estatus, crp_asignacion_correspondencia.observacion as obser_asig 
							FROM
...
<table width="100%" height="100%" cellpadding="1" cellspacing="0">
	<tr>
		<td align="center">
			<table width="99%" align="center" cellpadding="2" cellspacing="0">
				<tr>
					<td width="30px"><img src="images/revision.png"/></td>
					<td class="titulomenu" valign="middle">Recibir Correspondencia</td>
				</tr>
				<tr>
	...
	<tr>
		...
		<form action="" name="FormREC" id="FormREC" method="post">
					...
					<td align="center">
						<table border="0" cellpadding="3" ccellspacing="2" width="99%">
							<tr align="center" style="display:none" >
								<td colspan="3" align="center" height="0" id="diviR">                                   
								</td>
							</tr>							
							<tr>
...
<?
							...
							<tr>
								<td align="left" class="mensaje">
									<u>Nota:</u><br />
									<p align="justify">
										Aseg&uacute;rese de realizar este proceso una vez recibido de manos de Direcci&oacute;n General el documento.
									</p><br /><br />
								</td>
							</tr>						
							<tr>
								<td align="center">								
									...
									<input type="button" name="btnRegistrar" id="btnRegistrar" value="Recibir Correspondencia" title="Recibir Correspondencia" onclick="recibir();" />
									&nbsp;&nbsp;
