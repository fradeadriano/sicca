		...
		<td>
			<table width="99%" align="center" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td class="titulomenu" valign="middle">Correspondencias Asignadas</td>
				</tr>
				<tr>
						...
						<table border="0" width="100%" class="b_table_b" bgcolor="#F8F8F8"  cellpadding="2" cellspacing="0">
							<tr>
								...
								<td valign="bottom">
									<? 
									$rses = new Recordset();
									$rses->sql = "SELECT id_estatus, estatus FROM estatus WHERE orden BETWEEN 2 AND 7 order by orden"; 
							...
							<tr>
								...
								<td valign="bottom" colspan="4">
									<select name="sel_fecha"  id="sel_fecha">
										...
										<option id="documento" value="documento">Documento</option>
							...
							<tr class="trcabecera_list_ordenar">
								<td height="33">
									&nbsp;&nbsp;Ordenado por:&nbsp;&nbsp;<select name="por_ordenar" id="por_ordenar" onchange="filtrar(this.value);">
										...
										<option value="columna3">Organismo / Remitente</option>							
								...
								<td align="right" valign="middle">
									<img src="images/actualizar.png" style="cursor:pointer" title="Actualizar P&aacute;gina" onclick="cargar_lista_corres('modulos/correspondencia/monitoreo_unidad/monitoreo_list.php?pagina=1&met=DESC&Uunidad=<? echo $unidadD?>');" />&nbsp;&nbsp;Actualizar&nbsp;&nbsp;&nbsp;
								</td>
							</tr>				
...
echo '<script language="javascript" type="text/javascript">cargar_lista_corres("'.'modulos/correspondencia/monitoreo_unidad/monitoreo_list.php?pagina=1&Uunidad='.$unidadD.'&met=DESC");</script>'; 
?>
<script language="javascript" type="text/javascript">
	$("#organismo").autocomplete("modulos/correspondencia/monitoreo_unidad/lista.php", { 
		width: 400,
		matchContains: true,
		mustMatch: false,
		//minChars: 0,
...
setInterval('cargar_lista_corres("modulos/correspondencia/monitoreo_unidad/monitoreo_list.php?pagina=1&met=DESC&Uunidad=<? echo $unidadD; ?>")',1800000);		
</script>