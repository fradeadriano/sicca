...
var f2 = "";
	...
	if (document.getElementById("ndocumento").value == null || document.getElementById("ndocumento").value.length == 0 || /^\s+$/.test(document.getElementById("ndocumento").value)){		
			...
			// campo2 = ndocumento
			if (param==""){
				param = "campo2:"+document.getElementById("ndocumento").value;				
			} else {
				param = param+"!campo2:"+document.getElementById("ndocumento").value;							
			}		
		}			
...
function recibir(){
	...
	if(window.confirm(acentos('Desea registrar la recepci&oacute;n de la correspondencia?'))) 
		{	
			rt = "modulos/correspondencia/monitoreo_externo/reg_asignacion.php?recep="+document.getElementById("id_recep").value+"&modo=recibir"; 	
			llamarlistado(rt,spasc);
...
function devolucion(){
	...
	if(window.confirm(acentos('Desea registrar la Devoluci&oacute;n de la correspondencia?'))) 
		{	
			rt = "modulos/correspondencia/monitoreo_externo/reg_asignacion.php?recep="+document.getElementById("id_recep").value+"&mot="+document.getElementById("motivo").value+"&modo=devolucion"; 	
