...
function filtrar(co){
	...
	if(res==""){
		rt = "modulos/correspondencia/cgr/cgr_monitoreo_interno/monitoreo_list.php?pagina=1&p_orden="+co+"&met="+metod; 
	} else {
		rt = "modulos/correspondencia/cgr/cgr_monitoreo_interno/monitoreo_list.php?pagina=1&p_orden="+co+"&met="+metod+"&condiciones="+res; 	
	}	
	llamarlistado(rt,spasc);
}
//7
...
function doit(){
	...
	var ruta = "modulos/correspondencia/cgr/cgr_monitoreo_interno/monitoreo_list.php?pagina=1&condiciones="+param+"&met=DESC";
//	alert(ruta);	
...
*/	var inff = "";
	...
	if(window.confirm(acentos('Desea registrar la entrega de la correspondencia?'))) 
		{	
			rt = "modulos/correspondencia/cgr/cgr_monitoreo_interno/reg_asignacion.php?recep="+document.getElementById("id_corre_ex").value+"&modo=recibir"+"&corres="+document.getElementById("id_re").value+inff; 	
			
			llamarlistado(rt,spasc);
			alert(acentos("Ha finalizado satisfactoriamente el registro de la entrega!"));
			cargar_lista_corres('modulos/correspondencia/cgr/cgr_monitoreo_interno/monitoreo_list.php?pagina=1&met=DESC');
			closeMessage();		
		}
}
...
function recibir_x(){
	...
	if(window.confirm(acentos('Desea registrar la entrega de la correspondencia?'))) 
		{	
			rt = "modulos/correspondencia/cgr/cgr_monitoreo_interno/reg_asignacion.php?recep="+document.getElementById("id_corre_ex").value+"&modo=recibir_xx"+inff; 	
			llamarlistado(rt,spasc);
			alert(acentos("Ha finalizado satisfactoriamente el registro de la entrega!"));
			cargar_lista_corres('modulos/correspondencia/cgr/cgr_monitoreo_interno/monitoreo_list.php?pagina=1&met=DESC');
			closeMessage();		
