						...
						<table align="center" width="100%" border="0" cellspacing="2"  cellpadding="2" >			
							<tr>
								...
								<td valign="bottom" align="left" width="245">
									<? $rsun = new Recordset();	
									$rsun->sql = "SELECT id_unidad, unidad FROM unidad WHERE id_unidad <> 8 order by unidad"; 
									$rsun->llenarcombo($opciones = "\"unidad\"", $checked = "", $fukcion = "" , $diam = "style=\"width:240px; Height:20px;\""); 
									$rsun->cerrar(); 
									unset($rsun);																						
									?>								</td>
								<td><img src="images/Help_16x16.png" style="cursor:pointer" title="El campo Unidad Administrativa corresponde a la gerencia que se encargo del desarrollar de la solicitud" /></td>															
							</tr>
							<tr>
								<td valign="top" align="right">
									Direcci&oacute;n Despacho:&nbsp;								</td>
...
<script language="javascript" type="text/javascript">
	$("#organismo").autocomplete("modulos/correspondencia/cgr/cgr_procesar/lista.php", { 
		width: 400,
		matchContains: true,
		mustMatch: false,
		//minChars: 0,
