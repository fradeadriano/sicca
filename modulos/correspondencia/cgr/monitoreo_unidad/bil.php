...
function filtrar(co){
	...
	if(res==""){
		rt = "modulos/correspondencia/cgr/monitoreo_unidad/monitoreo_list.php?pagina=1&Uunidad="+document.getElementById("valorUnidad").value+"&p_orden="+co+"&met="+metod; 
	} else {
		rt = "modulos/correspondencia/cgr/monitoreo_unidad/monitoreo_list.php?pagina=1&Uunidad="+document.getElementById("valorUnidad").value+"&p_orden="+co+"&met="+metod+"&condiciones="+res; 	
	}	
	llamarlistado(rt,spasc);
}
//7
...
var param = "";
	...
	var ruta = "modulos/correspondencia/cgr/monitoreo_unidad/monitoreo_list.php?pagina=1&Uunidad="+Uu+"&condiciones="+param+"&met=DESC";
	//alert(ruta);	
...
function recibir(){
	...
	if(window.confirm(acentos('Desea registrar la recepci&oacute;n de la correspondencia?'))) 
		{	
			rt = "modulos/correspondencia/cgr/monitoreo_unidad/reg_asignacion.php?recep="+document.getElementById("id_recep").value+"&unidad="+document.getElementById("id_unidad").value+"&Ha=recib"; 	
			llamarlistado(rt,spasc);
			alert(acentos("Ha finalizado satisfactoriamente la Recepci&oacute;n de la correspondencia!"));
			cargar_lista_corres('modulos/correspondencia/cgr/monitoreo_unidad/monitoreo_list.php?pagina=1&Uunidad='+document.getElementById("id_unidad").value+'&met=DESC');
			closeMessage();		
		}
}
...
function habilitar(){
	...
	if(window.confirm(acentos('Desea habilitar la correspondencia?'))) 
		{	
			rt = "modulos/correspondencia/cgr/monitoreo_unidad/reg_asignacion.php?recep="+document.getElementById("id_recep").value+"&Ha=habilitar";	
			llamarlistado(rt,spasc);
...
function recibirCopia(v){
	...
	if(window.confirm(acentos('Desea registrar la recepci&oacute;n de la correspondencia?'))) 
		{	
			rt = "modulos/correspondencia/cgr/monitoreo_unidad/reg_asignacion.php?recep="+document.getElementById("id_recep").value+"&unidad="+document.getElementById("id_unidad").value+"&Ha=copia"; 	
			llamarlistado(rt,spasc);
			alert(acentos("Ha finalizado satisfactoriamente la Recepci&oacute;n de la correspondencia!"));
			cargar_lista_corres('modulos/correspondencia/cgr/monitoreo_unidad/monitoreo_list.php?pagina=1&Uunidad='+document.getElementById("id_unidad").value+'&met=DESC');
			closeMessage();		
