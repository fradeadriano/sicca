		...
		$search->sql = "SELECT id_crp_asignacion_correspondencia_cgr FROM crp_asignacion_correspondencia_cgr WHERE (id_recepcion_correspondencia_cgr = '".$recepcion."')";
			...
			if($search->total_registros != 0)
			{
				...
				$bus->sql = "SELECT 
								  ...
								  estatus.estatus, orga.organismo as orga_notificacion, crp_recepcion_correspondencia_cgr.n_notificacion, 
								  crp_recepcion_correspondencia_cgr.nombre, crp_recepcion_correspondencia_cgr.direccion, crp_recepcion_correspondencia_cgr.telefono, 
								...
								FROM
								  ...
								  LEFT JOIN organismo AS orga ON (crp_recepcion_correspondencia_cgr.id_organismo = orga.id_organismo)
							...
							?>
									...
									<table cellspacing="3" cellpadding="2" border="0" width="90%">
										<tr>
											...
											<td>
												<input type="text" name="fentrega" id="fentrega" style="width:70px" onkeyup="this.value=formateafecha(this.value,'2014','2014');" />&nbsp;<span class="mensaje">*</span>&nbsp;<span style="font-size:9px">ejmp.(dd/mm/yyyy)</span>
											</td>
										</tr>
										<tr>
