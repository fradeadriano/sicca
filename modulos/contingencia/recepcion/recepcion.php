		...
		<td>
			<table width="99%" align="center" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td class="titulomenu" valign="middle">Edici&oacute;n Correspondencia Recibida</td>
				</tr>
				<tr>
	...
	<tr>
		<td align="center">
			<table width="99%" border="0" class="b_table" cellpadding="3" cellspacing="3">
				<tr>
					<td align="center">
						Buscar Correspondencia:&nbsp;<input type="button" onclick="dosearch();" name="bsq" id="bsq" value="--" title="Buscar Correspondencia" />
					</td>
				</tr>
				<tr>
				...
				<tr id="mostrar" style="display:">
					<td>
						<iframe src="modulos/contingencia/recepcion/form.php" name="framo" id="framo" width="100%" height="700" frameborder="0"></iframe>
					</td>
				</tr>
			</table>				
		</td>
