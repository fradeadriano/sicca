...
function doit(){ //si
	...
	var ruta = "modulos/reportes/bateria2/tot_correspondencia/reporte_list.php?condiciones="+param;
	//alert(ruta);	
...
function exprt(){	
	...
	document.getElementById("rep").action = "modulos/reportes/bateria2/tot_correspondencia/excel.php";;
...
function graphi_s(){	
	...
	document.getElementById("gra").action = "modulos/reportes/bateria2/tot_correspondencia/titulo.php";
