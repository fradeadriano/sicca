...
function doit(){ //si
	...
	var ruta = "modulos/reportes/bateria2/seg_correspondencia/reporte_list.php?condicion="+param;
	//alert(ruta);	
...
function graphi_s(o){	
	...
	document.getElementById("gra").action = "modulos/reportes/bateria2/seg_correspondencia/titulo.php";
