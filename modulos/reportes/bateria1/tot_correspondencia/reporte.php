		...
		<td>
			<table width="99%" align="center" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td class="titulomenu" valign="middle">Totalizaci&oacute;n Correspondencia</td>
				</tr>
				<tr>
						...
						<table border="0" width="100%" class="b_table_b" bgcolor="#EEF7F9"  cellpadding="2" cellspacing="0">
							...
							<tr>															
								<td colspan="3" align="center">
									...
									&nbsp;&nbsp;
									Organ&iacute;smo&nbsp;<input type="radio" name="especi_seu" value="organismo" id="organismo" disabled="disabled"/>
									&nbsp;&nbsp;
									Unidad Administrativa&nbsp;<input type="radio" name="especi_seu" value="unidad" id="unidad" disabled="disabled"/>
									&nbsp;&nbsp;
									Prioridad&nbsp;<input type="radio" name="especi_seu" value="prioridad" id="prioridad" disabled="disabled"/>
									</form>
								</td>
							</tr>
							<tr><td height="10" colspan="3" ></td></tr>																
