		...
		<td>
			<table width="99%" align="center" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td class="titulomenu" valign="middle">Listado General Correspondencia</td>
				</tr>
				<tr>
							...
							<tr class="trcabecera_list_ordenar2">
								<td height="33">
									&nbsp;&nbsp;Ordenado por:&nbsp;&nbsp;<select name="por_ordenar" id="por_ordenar" onchange="filtrar(this.value);">
										...
										<option value="columna8">Prioridad</option>																				
									</select>
									&nbsp;&nbsp;&nbsp;
...
<script language="javascript" type="text/javascript">
	$("#organismo").autocomplete("modulos/reportes/bateria1/lis_general_correspondencia/lista.php", { 
		width: 400,
		matchContains: true,
		mustMatch: false,
		//minChars: 0,
