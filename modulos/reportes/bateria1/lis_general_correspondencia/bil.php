...
function filtrar(co){
	...
	if(res==""){
		rt = "modulos/reportes/bateria1/lis_general_correspondencia/reporte_list.php?p_orden="+co+"&met="+metod; 
	} else {
		rt = "modulos/reportes/bateria1/lis_general_correspondencia/reporte_list.php?p_orden="+co+"&met="+metod+"&condiciones="+res; 	
	}	
	llamarlistado(rt,spasc);
}
//7
...
function doit(){ //si
	...
	var ruta = "modulos/reportes/bateria1/lis_general_correspondencia/reporte_list.php?condiciones="+param+"&met=DESC";
	//alert(ruta);	
...
function exprt(){
	...
	document.getElementById("rep").action = "modulos/reportes/bateria1/lis_general_correspondencia/excel.php";;
