		...
		<td>
			<table width="99%" align="center" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td class="titulomenu" valign="middle">Seguimiento Correspondencia</td>
				</tr>
				<tr>
			...
			<table border="0" class="b_table">
				<tr>
					<td align="center">
						...
						<table border="0" width="100%" class="b_table_b" bgcolor="#EEF7F9"  cellpadding="2" cellspacing="0">
							<tr>
								<td align="center" colspan="2">
									Organ&iacute;smo&nbsp;<input type="radio" name="type_to" value="op_organismo" id="op_organismo"  onclick="habil(this.id);"/>
									&nbsp;
							...
							<tr id="di_organismo" style="display:none">															
								...
								<td valign="bottom" colspan="5">
									<textarea name="organismo" id="organismo" style="width:240px; height:60px;" ></textarea>&nbsp;<span class="mensaje">*</span>											
...
<script language="javascript" type="text/javascript">
	$("#organismo").autocomplete("modulos/reportes/bateria1/seg_correspondencia/lista.php", { 
		width: 240,
		matchContains: true,
		mustMatch: false,
		//minChars: 0,
