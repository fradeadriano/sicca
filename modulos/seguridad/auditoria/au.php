...
$search->sql = "select ID_BITACORA, usuario, DATE_FORMAT(fecha, '%d-%m-%Y') as fecha, DATE_FORMAT(hora, '%r') as hora , titulo_accion, accion from seg_bitacora $sqql where fecha BETWEEN '2015-09-01' 
  AND '2015-12-19' AND usuario <> 'admin' ORDER BY ID_bitacora DESC";
$search->abrir();
?>
